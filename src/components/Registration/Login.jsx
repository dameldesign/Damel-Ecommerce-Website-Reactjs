...
const Login = () => {
  ...
  return (
    <section class="flex flex-col w-ful mx-auto   overflow-hidden items-center bg-white  shadow-lg dark:bg-gray-800 md:flex-row-reverse md:h-[72rem]">
      <img src="" alt="" />{" "}
      <div class="md:flex md:items-center md:justify-center md:w-[80%] lg:w-[95%] h-full md:bg-gray-700 md:dark:bg-gray-800 lg:bg-gradient-secondary  lg:bg-cover lg:bg-center lg:bg-no-repeat" >
        <div class="px-6 py-6 md:px-8 md:py-0">
          <h2 class="text-lg font-bold text-gray-700 dark:text-white md:text-gray-100 sm:h-80 w-80">
            Sign Up For{" "}
      ...
      <div className=" lg:w-[60%] md:w-full items-center justify-between flex flex-col">
        <img src="/images/logo.png" alt="" className="w-80 h-80" />

      <div className="mx-auto lg:p-10 w-[350px] mb-8 lg:w-[650px]">
